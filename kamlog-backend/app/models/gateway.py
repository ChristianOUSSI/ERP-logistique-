...
class CommandeFacture(BaseModel):
    ...
    facture_id = Column(Integer, ForeignKey("factures.id", ondelete="CASCADE"), nullable=True)
    passerelle_id = Column(Integer, ForeignKey("passerelles.id", ondelete="CASCADE"), nullable=False)
...
class CommandeLivraison(BaseModel):
    ...
    id = Column(Integer, primary_key=True, index=True)
    commande_id = Column(Integer, ForeignKey("commandes.id", ondelete="CASCADE"), nullable=False)
    livraison_id = Column(Integer, ForeignKey("bandes_livraison.id", ondelete="CASCADE"), nullable=True)
    passerelle_id = Column(Integer, ForeignKey("passerelles.id", ondelete="CASCADE"), nullable=False)
...
class FacturePaiement(BaseModel):
    ...
    paiement_id = Column(Integer, ForeignKey("encaissements.id", ondelete="CASCADE"), nullable=True)
    passerelle_id = Column(Integer, ForeignKey("passerelles.id", ondelete="CASCADE"), nullable=False)
...
class MissionFacture(BaseModel):
    ...
    id = Column(Integer, primary_key=True, index=True)
    mission_id = Column(Integer, ForeignKey("missions_transport.id", ondelete="CASCADE"), nullable=False)
    facture_id = Column(Integer, ForeignKey("factures.id", ondelete="CASCADE"), nullable=True)
    passerelle_id = Column(Integer, ForeignKey("passerelles.id", ondelete="CASCADE"), nullable=False)
