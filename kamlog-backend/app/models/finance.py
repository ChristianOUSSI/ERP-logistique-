...
class Facture(BaseModel):
    ...
    mission_id: Mapped[int | None] = mapped_column(
        ForeignKey("missions_transport.id")
    )
    ...
    # Alias
    tva_xaf: Mapped[Decimal] = mapped_column(Numeric(15, 2), default=0.00)
...
class Encaissement(BaseModel):
    ...
    # Alias
    montant_xaf: Mapped[Decimal | None] = mapped_column(Numeric(15, 2))
