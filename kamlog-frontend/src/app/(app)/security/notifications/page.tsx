    ...
    <div className="space-y-6 max-w-7xl mx-auto animate-in fade-in duration-500 text-slate-100">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-slate-900 border border-slate-800 p-6 rounded-2xl shadow-xl">
        <div>
          ...
          <h1 className="text-2xl sm:text-3xl font-black tracking-tight">Centre de Notifications & Alertes</h1>
          <p className="text-slate-400 text-sm mt-1">Supervision temps réel des événements critiques, alertes QHSE et notifications système.</p>
        </div>
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-3 py-2.5 rounded-xl bg-slate-950 hover:bg-red-950/30 text-xs font-semibold text-slate-400 hover:text-red-400 border border-slate-800 transition-all cursor-pointer"
          >
