          ...
          <header className="bg-surface border-b border-outline-variant sticky top-0 w-full z-40 flex justify-between items-center h-[64px] px-gutter">
            ...
            <div className="flex items-center gap-4">
              <div className="relative focus-within:ring-2 focus-within:ring-primary rounded-full bg-surface-container-low px-4 py-2 flex items-center gap-2">
                ...
                <input className="bg-transparent border-none focus:ring-0 text-body-sm w-48 placeholder:text-outline p-0" placeholder="Rechercher T-Code" type="text"/>
                <div className="hidden absolute right-2 top-2 bg-surface border border-outline-variant rounded px-1 text-[10px] text-outline font-mono-data">⌘K</div>
              </div>
              <div className="flex items-center gap-2 text-secondary">
                ...
                <button className="p-2 hover:bg-surface-container-high rounded-full transition-colors"><span className="material-symbols-outlined">verified_user</span></button>
                <button className="p-2 hover:bg-surface-container-high rounded-full transition-colors"><span className="material-symbols-outlined">account_circle</span></button>
              </div>
            </div>
          </header>
