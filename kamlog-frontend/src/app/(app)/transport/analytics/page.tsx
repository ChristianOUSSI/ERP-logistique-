      ...
      <div className="max-w-7xl mx-auto py-8 px-4 animate-in fade-in duration-500">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-black text-slate-900 flex items-center gap-3">
            ...
            K-Analytics (Business Intelligence)
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-200">
            <h3 className="text-lg font-bold text-slate-800 mb-6">Évolution CA vs Dépenses</h3>
          ...
          {/* Marges par mois */}
          <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-200">
            <h3 className="text-lg font-bold text-slate-800 mb-6">Marge Nette (Bénéfice)</h3>
            <div className="h-80 w-full">
              {loading ? (
                <div className="h-full w-full bg-slate-50 rounded-xl animate-pulse"></div>
              ) : (
