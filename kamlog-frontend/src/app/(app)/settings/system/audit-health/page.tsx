        ...
        <aside className="bg-surface-container-lowest border-r border-outline-variant shadow-sm fixed left-0 top-0 h-full w-[260px] flex flex-col p-[1rem] z-50">
          ...
          <nav className="flex-1 overflow-y-auto py-2">
            <ul className="space-y-1 px-2">
              ...
              <li>
                <a onClick={() => router.push('/settings')} className="flex items-center gap-3 px-3 py-2 rounded text-primary bg-secondary-container font-bold font-label-caps text-label-caps active:scale-95 duration-150 border-l-4 border-primary cursor-pointer">
          ...
          <header className="bg-surface sticky top-0 w-full z-40 border-b border-outline-variant flex justify-between items-center h-[64px] px-[1rem] shrink-0">
            <div className="flex items-center gap-6">
              ...
              <nav className="hidden md:flex gap-6">
                <a onClick={() => router.push('/master-data/articles')} className="text-on-surface-variant font-body-base text-body-base hover:text-primary transition-all cursor-pointer">Articles</a>
                <a onClick={() => router.push('/master-data/clients')} className="text-on-surface-variant font-body-base text-body-base hover:text-primary transition-all cursor-pointer">Clients</a>
                <a onClick={() => router.push('/magasin')} className="text-on-surface-variant font-body-base text-body-base hover:text-primary transition-all cursor-pointer">Stocks</a>
                <a onClick={() => router.push('/reports')} className="text-on-surface-variant font-body-base text-body-base hover:text-primary transition-all cursor-pointer">Rapports</a>
              </nav>
            </div>
