  ...
  return (
    <>
      ...
      <div className="bg-background text-on-surface font-body-base antialiased flex overflow-hidden h-screen selection:bg-module-green-light selection:text-module-green-dark">
        {/* SideNavBar */}
        <nav className="bg-surface-container-lowest border-r border-outline-variant shadow-sm fixed left-0 top-0 h-full w-[260px] flex flex-col h-screen p-stack-md z-50">
          {/* Brand */}
          ...
          {/* CTA */}
          <button className="bg-module-green text-white rounded-lg py-2.5 px-4 flex items-center justify-center gap-2 mb-8 font-title-sm text-title-sm hover:bg-module-green-dark transition-colors active:scale-95 duration-150 shadow-sm w-full">
          ...
          <header className="bg-surface sticky top-0 w-full z-40 border-b border-outline-variant flex justify-between items-center h-[64px] px-gutter shrink-0">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="relative group focus-within:ring-2 focus-within:ring-primary rounded-lg overflow-hidden border border-outline-variant bg-surface-container-lowest flex items-center h-9">
                ...
                <input className="bg-transparent border-none focus:ring-0 text-sm w-48 font-mono-data text-mono-data placeholder:font-body-base" placeholder="Rechercher T-Code" type="text"/>
                <div className="hidden group-focus-within:flex absolute top-full left-0 w-full bg-surface-container-lowest border border-outline-variant mt-1 rounded-lg shadow-lg z-50 flex-col">
                  ...
                  <a className="px-3 py-2 text-sm hover:bg-surface-container-high flex justify-between" href="#"><span className="font-mono-data text-module-green">TR01</span><span>Create Tier</span></a>
                  <a className="px-3 py-2 text-sm hover:bg-surface-container-high flex justify-between" href="#"><span className="font-mono-data text-module-green">TR02</span><span>Edit Tier</span></a>
                </div>
              </div>
              {/* Icon Actions */}
              <div className="flex items-center gap-2 text-on-surface-variant">
                <button className="w-8 h-8 rounded-full hover:bg-surface-container-high flex items-center justify-center transition-colors relative">
                  ...
                  <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-module-green rounded-full border border-surface-container-lowest"></span>
                </button>
                ...
                <div className="overflow-auto flex-1 relative">
                  <table className="w-full text-left border-collapse">
                    ...
                    <tbody className="divide-y divide-outline-variant">
                      ...
                      <tr className="hover:bg-surface-container cursor-pointer group"><td className="py-3 px-4 text-center"><input className="rounded border-outline-variant text-module-green focus:ring-module-green" type="checkbox"/></td><td className="py-3 px-4 font-mono-data text-mono-data text-on-surface">C-3349</td><td className="py-3 px-4"><div className="font-title-sm text-title-sm text-on-surface">West Africa Logistics</div><div className="font-body-sm text-body-sm text-on-surface-variant">Lagos, Nigeria</div></td><td className="py-3 px-4"><span className="inline-flex items-center px-2 py-1 rounded bg-secondary-container text-on-secondary-container font-label-caps text-[10px]">Logistics</span></td><td className="py-3 px-4 font-mono-data text-mono-data text-on-surface text-right">€ 420,000</td><td className="py-3 px-4 text-center"><span className="inline-flex items-center px-2 py-1 rounded-full bg-[#d1fae5] text-[#065f46] font-label-caps text-[10px] gap-1"><span className="w-1.5 h-1.5 rounded-full bg-[#059669]"></span> Active</span></td><td className="py-3 px-4 text-right"><div className="flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity"><button className="p-1 rounded hover:bg-surface-variant text-on-surface-variant transition-colors" title="View Details"><span className="material-symbols-outlined text-[18px]">visibility</span></button><button className="p-1 rounded hover:bg-surface-variant text-on-surface-variant transition-colors" title="Edit"><span className="material-symbols-outlined text-[18px]">edit</span></button></div></td></tr>
                      <tr className="bg-surface-bright hover:bg-surface-container cursor-pointer group"><td className="py-3 px-4 text-center"><input className="rounded border-outline-variant text-module-green focus:ring-module-green" type="checkbox"/></td><td className="py-3 px-4 font-mono-data text-mono-data text-on-surface">C-5582</td><td className="py-3 px-4"><div className="font-title-sm text-title-sm text-on-surface">TransSahara Freight</div><div className="font-body-sm text-body-sm text-on-surface-variant">Bamako, Mali</div></td><td className="py-3 px-4"><span className="inline-flex items-center px-2 py-1 rounded bg-secondary-container text-on-secondary-container font-label-caps text-[10px]">Logistics</span></td><td className="py-3 px-4 font-mono-data text-mono-data text-on-surface text-right">€ 180,000</td><td className="py-3 px-4 text-center"><span className="inline-flex items-center px-2 py-1 rounded-full bg-[#d1fae5] text-[#065f46] font-label-caps text-[10px] gap-1"><span className="w-1.5 h-1.5 rounded-full bg-[#059669]"></span> Active</span></td><td className="py-3 px-4 text-right"><div className="flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity"><button className="p-1 rounded hover:bg-surface-variant text-on-surface-variant transition-colors" title="View Details"><span className="material-symbols-outlined text-[18px]">visibility</span></button><button className="p-1 rounded hover:bg-surface-variant text-on-surface-variant transition-colors" title="Edit"><span className="material-symbols-outlined text-[18px]">edit</span></button></div></td></tr>
                    </tbody>
                  </table>
                </div>
                {/* Pagination Footer */}
