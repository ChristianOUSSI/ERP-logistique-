// src/app/(app)/admin/users/page.tsx - Admin User Management & RBAC ERP Design
'use client'

import { 
  Dashboard, LocalShipping, Payments, MinorCrash, Settings,
  HelpOutline, Logout, Add, Search, FilterList, Download,
  PersonAdd, MoreVert, CheckCircle, Close, Anchor
} from 'lucide-react'
      ...
      <nav className="bg-surface-container-lowest text-primary fixed left-0 top-0 h-full w-[260px] border-r border-outline-variant shadow-sm flex flex-col p-md z-50">
        ...
        <div className="mb-xl flex items-center gap-sm">
          <div className="w-10 h-10 rounded-full bg-primary-container flex items-center justify-center shrink-0">
            <Anchor className="text-on-primary-container" size={20} />
          </div>
          <div>
        ...
        <header className="bg-surface sticky top-0 w-full z-40 border-b border-outline-variant flex justify-between items-center h-[64px] px-gutter">
          ...
          <div className="flex items-center gap-md">
            ...
            <div className="relative hidden lg:block focus-within:ring-2 focus-within:ring-primary rounded-lg">
              <Search className="absolute left-sm top-1/2 -translate-y-1/2 text-on-surface-variant" size={18} />
              <input 
                className="bg-surface-container-high border-none rounded-lg pl-xl pr-sm py-xs font-body-sm text-body-sm text-on-surface focus:ring-0 w-64 placeholder:text-on-surface-variant" 
            ...
            <div className="flex-1 bg-surface rounded-xl border border-outline-variant shadow-sm flex flex-col overflow-hidden">
              ...
              <div className="p-md border-b border-outline-variant bg-surface flex justify-between items-center">
                <div className="relative w-72">
                  <Search className="absolute left-sm top-1/2 -translate-y-1/2 text-on-surface-variant" size={18} />
                  <input 
                    className="w-full bg-surface-container-low border border-outline-variant rounded-lg pl-xl pr-sm py-xs font-body-sm text-body-sm text-on-surface focus:ring-2 focus:ring-primary focus:border-primary placeholder:text-on-surface-variant transition-all" 
