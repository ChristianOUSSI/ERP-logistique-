                ...
                <div className="overflow-auto flex-1 relative">
                  <table className="w-full text-left border-collapse">
                    ...
                    <tbody className="divide-y divide-outline-variant">
                      ...
                      {/* Additional rows */}
                      <tr className="hover:bg-surface-container cursor-pointer group"><td className="py-3 px-4 text-center"><input className="rounded border-outline-variant text-[#10B981] focus:ring-[#10B981]" type="checkbox"/></td><td className="py-3 px-4 font-mono-data text-mono-data text-on-surface">C-3349</td><td className="py-3 px-4"><div className="font-title-sm text-title-sm text-on-surface">West Africa Logistics</div><div className="font-body-sm text-body-sm text-on-surface-variant">Lagos, Nigeria</div></td><td className="py-3 px-4"><span className="inline-flex items-center px-2 py-1 rounded bg-secondary-container text-on-secondary-container font-label-caps text-[10px]">Logistics</span></td><td className="py-3 px-4 font-mono-data text-mono-data text-on-surface text-right">FCFA 420,000</td><td className="py-3 px-4 text-center"><span className="inline-flex items-center px-2 py-1 rounded-full bg-[#d1fae5] text-[#065f46] font-label-caps text-[10px] gap-1"><span className="w-1.5 h-1.5 rounded-full bg-[#059669]"></span> Active</span></td><td className="py-3 px-4 text-right"><div className="flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity"><button className="p-1 rounded hover:bg-surface-variant text-on-surface-variant transition-colors" title="View Details"><span className="material-symbols-outlined text-[18px]">visibility</span></button><button className="p-1 rounded hover:bg-surface-variant text-on-surface-variant transition-colors" title="Edit"><span className="material-symbols-outlined text-[18px]">edit</span></button></div></td></tr>
                      <tr className="bg-surface-bright hover:bg-surface-container cursor-pointer group"><td className="py-3 px-4 text-center"><input className="rounded border-outline-variant text-[#10B981] focus:ring-[#10B981]" type="checkbox"/></td><td className="py-3 px-4 font-mono-data text-mono-data text-on-surface">C-5582</td><td className="py-3 px-4"><div className="font-title-sm text-title-sm text-on-surface">TransSahara Freight</div><div className="font-body-sm text-body-sm text-on-surface-variant">Bamako, Mali</div></td><td className="py-3 px-4"><span className="inline-flex items-center px-2 py-1 rounded bg-secondary-container text-on-secondary-container font-label-caps text-[10px]">Logistics</span></td><td className="py-3 px-4 font-mono-data text-mono-data text-on-surface text-right">FCFA 180,000</td><td className="py-3 px-4 text-center"><span className="inline-flex items-center px-2 py-1 rounded-full bg-[#d1fae5] text-[#065f46] font-label-caps text-[10px] gap-1"><span className="w-1.5 h-1.5 rounded-full bg-[#059669]"></span> Active</span></td><td className="py-3 px-4 text-right"><div className="flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity"><button className="p-1 rounded hover:bg-surface-variant text-on-surface-variant transition-colors" title="View Details"><span className="material-symbols-outlined text-[18px]">visibility</span></button><button className="p-1 rounded hover:bg-surface-variant text-on-surface-variant transition-colors" title="Edit"><span className="material-symbols-outlined text-[18px]">edit</span></button></div></td></tr>
                    </tbody>
                  </table>
                </div>
                {/* Pagination Footer */}
