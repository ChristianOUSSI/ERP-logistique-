      ...
      <div className="bg-surface-container-low text-on-surface font-body-md min-h-screen flex">
        ...
        <nav className="fixed left-0 top-0 h-full flex flex-col z-40 w-[240px] flex-shrink-0 bg-surface-container-low border-r border-outline-variant">
          ...
          <ul className="flex-1 overflow-y-auto py-2">
            <li>
              <a onClick={() => router.push('/transport')} className="flex items-center gap-3 px-6 py-3 font-label-md text-label-md text-on-surface-variant hover:text-on-surface hover:bg-surface-container transition-all duration-200 ease-in-out cursor-pointer">
                <span className="material-symbols-outlined" style={{fontSize: '20px'}}>local_shipping</span>
                Transport
              </a>
            </li>
            <li>
              <a onClick={() => router.push('/magasin')} className="flex items-center gap-3 px-6 py-3 font-label-md text-label-md text-on-surface-variant hover:text-on-surface hover:bg-surface-container transition-all duration-200 ease-in-out cursor-pointer">
                <span className="material-symbols-outlined" style={{fontSize: '20px'}}>inventory_2</span>
                Magasin
              </a>
            </li>
            <li>
              <a onClick={() => router.push('/finance')} className="flex items-center gap-3 px-6 py-3 font-label-md text-label-md text-on-surface-variant hover:text-on-surface hover:bg-surface-container transition-all duration-200 ease-in-out cursor-pointer">
            ...
            <li>
              {/* Active Item */}
              <a onClick={() => router.push('/parc')} className="flex items-center gap-3 px-6 py-3 font-label-md text-label-md transition-all duration-200 ease-in-out text-primary bg-surface-container-highest border-l-4 border-primary font-bold cursor-pointer">
                <span className="material-symbols-outlined" style={{fontSize: '20px'}}>local_parking</span>
                Parc
              </a>
            </li>
            <li>
              <a onClick={() => router.push('/audit')} className="flex items-center gap-3 px-6 py-3 font-label-md text-label-md text-on-surface-variant hover:text-on-surface hover:bg-surface-container transition-all duration-200 ease-in-out cursor-pointer">
          ...
          <div className="border-t border-outline-variant py-2">
            <a onClick={() => router.push('/support')} className="flex items-center gap-3 px-6 py-3 font-label-md text-label-md text-on-surface-variant hover:text-on-surface hover:bg-surface-container transition-all duration-200 ease-in-out cursor-pointer">
              <span className="material-symbols-outlined" style={{fontSize: '20px'}}>support_agent</span>
              Support
            </a>
            <a onClick={() => router.push('/logout')} className="flex items-center gap-3 px-6 py-3 font-label-md text-label-md text-on-surface-variant hover:text-on-surface hover:bg-surface-container transition-all duration-200 ease-in-out cursor-pointer">
        ...
        <main className="ml-[240px] flex-1 flex flex-col h-screen overflow-hidden">
          {/* TopNavBar */}
          <header className="h-16 bg-surface border-b border-outline-variant flex items-center justify-between px-[1.5rem] w-full flex-shrink-0">
            <div className="flex items-center gap-4">
              <div className="flex items-center text-sm text-on-surface-variant">
                <span onClick={() => router.push('/parc')} className="hover:text-primary cursor-pointer">K-Parc</span>
                <span className="material-symbols-outlined mx-1" style={{fontSize: '16px'}}>chevron_right</span>
                <span onClick={() => router.push('/parc/work-orders')} className="hover:text-primary cursor-pointer">Ordres de Travail</span>
                <span className="material-symbols-outlined mx-1" style={{fontSize: '16px'}}>chevron_right</span>
            ...
            <div className="flex items-center gap-4">
              ...
              <div onClick={() => router.push('/profile')} className="w-8 h-8 rounded-full bg-surface-container-highest overflow-hidden border border-outline-variant cursor-pointer">
