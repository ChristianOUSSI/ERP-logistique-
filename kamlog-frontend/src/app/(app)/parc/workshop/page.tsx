// src/app/(app)/parc/workshop/page.tsx - K-Parc Workshop Maintenance - Fidèle 100% au HTML original
'use client'
  ...
  return (
    <>
      ...
      <div className="bg-surface-container-low text-on-background font-body-md min-h-screen flex">
        {/* SideNavBar */}
        <nav className="hidden md:flex flex-col h-screen p-md bg-surface-container-lowest fixed left-0 top-0 h-full w-[260px] border-r border-outline-variant shadow-sm z-50">
          {/* Header */}
          ...
          {/* Primary CTA */}
          <button className="w-full bg-primary text-on-primary font-label-md text-label-md py-sm px-md rounded flex items-center justify-center gap-xs mb-lg hover:bg-primary/90 transition-colors">
        ...
        <div className="flex-1 flex flex-col md:ml-[260px] min-h-screen">
          ...
          <header className="sticky top-0 w-full z-40 bg-surface border-b border-outline-variant flex justify-between items-center h-[64px] px-gutter">
            ...
            {/* Center: Search */}
            <div className="flex-1 max-w-md mx-md">
              <div className="relative flex items-center w-full focus-within:ring-2 focus-within:ring-primary rounded bg-surface-container-low border border-outline-variant px-sm py-1.5 transition-all">
            ...
            <div className="flex items-center gap-sm">
              <button className="p-xs text-on-surface-variant hover:text-primary transition-all rounded hover:bg-surface-container-high">
          ...
          {/* Main Canvas */}
          <main className="flex-1 p-gutter max-w-max-width w-full mx-auto overflow-y-auto">
            ...
            <div className="grid grid-cols-12 gap-gutter h-full">
              ...
              <div className="col-span-12 lg:col-span-8 flex flex-col gap-gutter">
                ...
                <div className="grid grid-cols-3 gap-sm">
                  <div className="bg-surface-container-lowest border border-outline-variant p-sm rounded-lg flex flex-col justify-between relative overflow-hidden">
                    ...
                    <div className="flex items-end gap-2 z-10">
                      <span className="font-headline-lg text-headline-lg text-on-surface font-bold leading-none">12</span>
                  ...
                  <div className="bg-surface-container-lowest border border-outline-variant p-sm rounded-lg flex flex-col justify-between relative overflow-hidden">
                    ...
                    <div className="flex items-end gap-2 z-10">
                      <span className="font-headline-lg text-headline-lg text-on-surface font-bold leading-none">84%</span>
                  ...
                  <div className="bg-surface-container-lowest border border-outline-variant p-sm rounded-lg flex flex-col justify-between relative overflow-hidden">
                    ...
                    <div className="flex items-end gap-2 z-10">
                      <span className="font-headline-lg text-headline-lg text-on-surface font-bold leading-none">05</span>
                ...
                <div className="bg-surface-container-lowest border border-outline-variant rounded-lg flex-1 flex flex-col min-h-[400px]">
                  <div className="px-sm py-xs border-b border-outline-variant flex justify-between items-center bg-surface-container-low">
                    <h2 className="font-title-md text-title-md font-bold text-on-surface flex items-center gap-xs">
                    ...
                    <table className="w-full text-left border-collapse font-data-tabular text-data-tabular">
                      <thead>
                        <tr className="bg-surface-container text-on-surface-variant uppercase tracking-wider font-label-sm text-label-sm border-b border-outline-variant">
                          <th className="px-sm py-2 font-semibold">ID Véhicule</th>
                          <th className="px-sm py-2 font-semibold">Type</th>
                          <th className="px-sm py-2 font-semibold">Problème Signalé</th>
                          <th className="px-sm py-2 font-semibold">Mécanicien</th>
                          <th className="px-sm py-2 font-semibold">Statut</th>
                          <th className="px-sm py-2 font-semibold text-right">Actions</th>
                        </tr>
                      </thead>
                      <tbody className="divide-y divide-outline-variant text-on-surface">
                        <tr className="hover:bg-surface-container-low transition-colors h-[40px] border-l-2 border-primary">
                          <td className="px-sm py-1 font-medium">TRK-4092</td>
                          <td className="px-sm py-1 text-on-surface-variant">Tracteur Lourd</td>
                          <td className="px-sm py-1">Fuite hydraulique (Grue)</td>
                          <td className="px-sm py-1 flex items-center gap-2">
                            <div className="w-5 h-5 rounded-full bg-primary-container text-on-primary-container flex items-center justify-center font-label-sm text-[9px] font-bold">MK</div>
                            M. Kouamé
                          </td>
                          <td className="px-sm py-1">
                            <span className="inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-bold bg-primary/10 text-primary">En cours</span>
                          </td>
                        ...
                        <tr className="hover:bg-surface-container-low transition-colors h-[40px]">
                          <td className="px-sm py-1 font-medium">FLT-102</td>
                          <td className="px-sm py-1 text-on-surface-variant">Chariot Élévateur</td>
                          <td className="px-sm py-1">Remplacement batterie</td>
                          <td className="px-sm py-1 flex items-center gap-2">
                            <div className="w-5 h-5 rounded-full bg-secondary-container text-on-secondary-container flex items-center justify-center font-label-sm text-[9px] font-bold">SD</div>
                            S. Diarrassouba
                          </td>
                          <td className="px-sm py-1">
                            <span className="inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-bold bg-secondary/10 text-secondary">Terminé (Test)</span>
                          </td>
                          <td className="px-sm py-1 text-right">
                            <button className="text-on-surface-variant hover:text-primary p-1"><span className="material-symbols-outlined text-[16px]">more_vert</span></button>
                          </td>
                        </tr>
                        <tr className="hover:bg-surface-container-low transition-colors h-[40px] border-l-2 border-error">
                          <td className="px-sm py-1 font-medium">VUL-884</td>
                          <td className="px-sm py-1 text-on-surface-variant">Utilitaire Léger</td>
                          <td className="px-sm py-1 text-error">Panne moteur - En attente pièces</td>
                          <td className="px-sm py-1 flex items-center gap-2">
                            <div className="w-5 h-5 rounded-full bg-tertiary-container text-on-tertiary-container flex items-center justify-center font-label-sm text-[9px] font-bold">AT</div>
                            A. Touré
                          </td>
                          <td className="px-sm py-1">
                            <span className="inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-bold bg-error/10 text-error">Bloqué</span>
                          </td>
                          <td className="px-sm py-1 text-right">
                            <button className="text-on-surface-variant hover:text-primary p-1"><span className="material-symbols-outlined text-[16px]">more_vert</span></button>
                          </td>
                        ...
                        <tr className="hover:bg-surface-container-low transition-colors h-[40px]">
                          <td className="px-sm py-1 font-medium">TRK-3921</td>
                          <td className="px-sm py-1 text-on-surface-variant">Tracteur Standard</td>
                          <td className="px-sm py-1">Révision 50k KM</td>
                          <td className="px-sm py-1 flex items-center gap-2">
                            <div className="w-5 h-5 rounded-full bg-primary-container text-on-primary-container flex items-center justify-center font-label-sm text-[9px] font-bold">MK</div>
                            M. Kouamé
                          </td>
                          <td className="px-sm py-1">
                            <span className="inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-bold bg-outline-variant/30 text-on-surface-variant">À assigner</span>
                          </td>
                          <td className="px-sm py-1 text-right">
                            <button className="text-on-surface-variant hover:text-primary p-1"><span className="material-symbols-outlined text-[16px]">more_vert</span></button>
                          </td>
              ...
              <div className="col-span-12 lg:col-span-4 flex flex-col gap-gutter">
                ...
                <div className="bg-primary-container/80 backdrop-blur-md border border-primary/20 rounded-lg p-sm relative overflow-hidden">
                  <div className="absolute -right-4 -top-4 w-24 h-24 bg-primary rounded-full opacity-20 blur-xl"></div>
                  <h3 className="font-title-md text-title-md font-bold text-on-primary-container mb-xs">Accès Rapide T-Code</h3>
                ...
                <div className="bg-surface-container-lowest border border-outline-variant rounded-lg flex-1 flex flex-col">
                  ...
                  <div className="p-sm flex-1 overflow-y-auto space-y-2">
