// src/app/(app)/magasin/page.tsx - K-Magasin Dashboard - Fidèle 100% au HTML original
'use client'
        ...
        <aside className="bg-surface-container-lowest text-on-surface flex flex-col h-screen p-stack-md fixed left-0 top-0 h-full w-[260px] border-r border-outline-variant shadow-sm z-50">
          ...
          <nav className="flex-1 flex flex-col gap-1">
            ...
            <a className="flex items-center gap-3 px-3 py-2 rounded text-primary bg-primary-container font-bold font-label-caps text-label-caps active:scale-95 duration-150" href="/magasin/dashboard">
              <span className="material-symbols-outlined fill-icon">warehouse</span>
              K-Magasin
            </a>
          ...
          <header className="bg-surface text-primary sticky top-0 w-full z-40 border-b border-outline-variant flex justify-between items-center h-[64px] px-gutter">
            ...
            <div className="flex items-center gap-stack-md">
              <div className="relative focus-within:ring-2 focus-within:ring-primary rounded">
                ...
                <input className="pl-9 pr-4 py-1.5 bg-surface-container-highest border-none rounded text-on-surface font-mono-data text-mono-data focus:outline-none w-48" placeholder="Rechercher T-Code" type="text" value="KM24"/>
                <div className="absolute right-0 top-full mt-1 w-full bg-surface-container-lowest border border-outline-variant rounded shadow-lg z-50 hidden">
                  {/* Quick Jump Hint for T-Code */}
                  <div className="p-2 flex items-center gap-2 hover:bg-surface-container-high cursor-pointer">
                    <span className="material-symbols-outlined text-primary text-sm">bolt</span>
                    <span className="font-mono-data text-xs text-on-surface">Jump to Reception KM24</span>
                  </div>
                </div>
              </div>
              <div className="flex items-center gap-2 text-on-surface-variant">
                <button className="p-1.5 hover:bg-surface-container-high rounded-full transition-colors"><span className="material-symbols-outlined">notifications</span></button>
                <button className="p-1.5 hover:bg-surface-container-high rounded-full transition-colors"><span className="material-symbols-outlined">verified_user</span></button>
                <button className="p-1.5 hover:bg-surface-container-high rounded-full transition-colors"><span className="material-symbols-outlined">account_circle</span></button>
              </div>
            </div>
          </header>
          ...
          <div className="flex-1 overflow-y-auto p-container-margin">
            ...
            <div className="grid grid-cols-12 gap-stack-md">
              ...
              <div className="col-span-12 lg:col-span-8 grid grid-cols-2 md:grid-cols-4 gap-stack-md">
                {/* KPI 1 */}
                <div className="bg-surface-container-lowest border border-outline-variant rounded-lg p-4 shadow-sm flex flex-col justify-between hover-scale transition-transform duration-150">
                ...
                <div className="bg-surface-container-lowest border border-outline-variant rounded-lg p-4 shadow-sm flex flex-col justify-between hover-scale transition-transform duration-150">
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <span className="material-symbols-outlined text-outline">warehouse</span>
                  </div>
                  <div>
                ...
                <div className="flex flex-col gap-2">
                  <button className="w-full text-left px-3 py-2 rounded bg-surface-container hover:bg-surface-container-high transition-colors flex items-center justify-between border border-transparent hover:border-outline-variant">
                    <div className="flex items-center gap-2">
                      <span className="material-symbols-outlined text-primary text-sm">add_box</span>
                    ...
                    <tbody className="font-body-sm text-body-sm text-on-surface divide-y divide-outline-variant">
                      <tr className="hover:bg-surface-container-low transition-colors group h-grid-row-height">
                        ...
                        <td className="px-4 py-2 text-right opacity-0 group-hover:opacity-100 transition-opacity">
                          <button className="text-secondary hover:text-primary"><span className="material-symbols-outlined text-sm">visibility</span></button>
                        </td>
                      </tr>
                      <tr className="hover:bg-surface-container-low transition-colors group h-grid-row-height">
