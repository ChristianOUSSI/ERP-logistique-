          ...
          <header className="bg-surface sticky top-0 w-full z-40 border-b border-outline-variant flex justify-between items-center h-[64px] px-[1rem] shrink-0">
            <div className="flex items-center gap-6">
              ...
              <nav className="hidden md:flex gap-6">
                ...
                <a onClick={() => router.push('/magasin/mouvement-de-stock-manuel')} className="text-on-surface-variant font-body-base text-body-base hover:text-error transition-all cursor-pointer">Mouvements</a>
                <span className="text-on-surface font-bold">Bon d'Enlèvement (Mag3)</span>
              </nav>
            </div>
            <div className="flex items-center gap-4">
              <div className="relative focus-within:ring-2 focus-within:ring-error rounded">
