// src/app/(app)/dashboard/global/page.tsx - KAMLOG ERP Global Dashboard - Fidèle 100% au HTML original
'use client'
        ...
        <header className="fixed top-0 left-0 w-full z-50 flex justify-between items-center px-lg h-16 bg-surface-container-low border-b border-outline-variant">
          ...
          <div className="flex items-center gap-md">
            ...
            <div className="w-8 h-8 rounded-full overflow-hidden bg-outline-variant">
              <img alt="User Profile Avatar" className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDlVGmjmhA1cMwRWovq_WLrw2YhDeovqVj5zlc62N7PTWlcRm0NlItJcbgP48oTZ3yDucvCUi2eBXx4-jMUY9gHt0rvrF78R3tCOps7BI5OTw8TYGpKFjj-18M2lOrWCuXzLO_8e0MpJyg3wc0cbm1JqXyvylrePXFUzLPjSoz05UB-pqlW2x30uvIK2pZH2zK8ebn1_aeYc46LdyiBjz23OKitO-HoYRwHQwcQDdW625aVqF-AzCWwo28S1TkehLQJx87bu-5YT3E"/>
            </div>
          </div>
        </header>
        {/* SideNavBar Shell */}
          ...
          <div className="p-lg max-w-max-width mx-auto">
            ...
            <div className="grid grid-cols-12 gap-gutter">
              ...
              <div className="col-span-12 lg:col-span-8">
                <div className={`bg-white p-lg rounded-xl border border-outline-variant h-full transition-transform ${tcodeFocused ? 'scale-[1.01]' : ''}`}>
                    ...
                    <table className="w-full text-left zebra-table">
                      ...
                      <tbody className="text-body-sm font-body-sm text-on-surface">
                        <tr>
                          ...
                          <td className="px-lg py-md flex items-center gap-xs">
                            <div className="w-6 h-6 rounded-full bg-outline-variant overflow-hidden">
                              <img alt="Operator" className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBLy38_eejwPr8MJHy0ltkC9gM0IhfzDluBsW19c59fB5KHkH9QXr0D620A3BoyqpQh7tr0FU9oPQJPN7SU-cUAZ5VGnKfew91Joevp5FKZNNRkxtQ9lkkck7WJoI70NtqXivS2Sh1cJwJPSzwW7ykhSrULhHk1o4hOM_q0CGNGd9LEIdubTFLn9hJ-pRJq8uHBi5R1FO2TVTkTe2XD7SHH2eMrsidalitObeo0mMvScuLTbMesUHOYY4Vrmk6IP4r3o47b_fGIeTg"/>
                            </div>
                            J. Chen
                          </td>
                        ...
                        <tr>
                          ...
                          <td className="px-lg py-md flex items-center gap-xs">
                            <div className="w-6 h-6 rounded-full bg-outline-variant overflow-hidden">
                              <img alt="Operator" className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAjtO3F6zz5RxJhlvw7cVK_sm404zUMOJh_qR7AJacaoXBdGHxY2UYi36rWINW1Zu8TH5GwuK3dWVMCKs954MPUr3JQv6ebP8twJUlBV0WA6-E-Bm1zOmvlWMrwxFr73KdOioe4Jnm32mMrm8RcjlcsydDjGuuvroSBIR5QwbZzcP6nuKnMQdGUX78mrS2-HBGWf5T6G1mAaExa8FZIyArMs8BMMLEoUNYtN7MsM3sMRpT6G8-HDzOVzc6Wzc_YYDgN-wPMbfKvSlI"/>
                            </div>
                            S. Miller
                          </td>
                          <td className="px-lg py-md">
