...
export default function GlobalDashboard() {
  ...
  useEffect(() => {
    ...
    if (tcodeInput) {
      const handleFocus = () => {
        tcodeInput.parentElement?.classList.add('scale-[1.01]')
      }
      const handleBlur = () => {
        tcodeInput.parentElement?.classList.remove('scale-[1.01]')
      }
      tcodeInput.addEventListener('focus', handleFocus)
      tcodeInput.addEventListener('blur', handleBlur)
      return () => {
        tcodeInput.removeEventListener('focus', handleFocus)
  ...
  return (
    <>
      ...
      <div className="bg-surface-container-low text-on-surface min-h-screen">
        {/* TopAppBar Shell */}
        <header className="fixed top-0 left-0 w-full z-50 flex justify-between items-center px-lg h-16 bg-surface-container-low border-b border-outline-variant dark:border-outline">
          <div className="flex items-center gap-xl">
            <span className="text-title-lg font-title-lg font-bold text-primary dark:text-primary-fixed-dim">KAMLOG EM-ERP</span>
          ...
          <div className="flex items-center gap-md">
            ...
            <div className="w-8 h-8 rounded-full overflow-hidden bg-outline-variant">
              <img 
                ...
                data-alt="A professional headshot of a corporate logistics manager wearing a crisp white shirt against a neutral, high-key studio background. The lighting is soft and professional, reflecting the reliable and modern corporate style of the KAMLOG ERP interface. The image is clean, sharp, and fits perfectly within a minimalist UI profile circle." 
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuDlVGmjmhA1cMwRWovq_WLrw2YhDeovqVj5zlc62N7PTWlcRm0NlItJcbgP48oTZ3yDucvCUi2eBXx4-jMUY9gHt0rvrF78R3tCOps7BI5OTw8TYGpKFjj-18M2lOrWCuXzLO_8e0MpJyg3wc0cbm1JqXyvylrePXFUzLPjSoz05UB-pqlW2x30uvIK2pZH2zK8ebn1_aeYc46LdyiBjz23OKitO-HoYRwHQwcQDdW625aVqF-AzCWwo28S1TkehLQJx87bu-5YT3E"
              />
            </div>
          </div>
        </header>
        ...
        {/* SideNavBar Shell */}
        <aside className="fixed left-0 top-0 h-full w-60 flex flex-col pt-16 pb-md z-40 bg-surface-container-low dark:bg-surface-container-lowest border-r border-outline-variant">
            ...
            <div className="grid grid-cols-12 gap-gutter">
                ...
                <div className="bg-white p-lg rounded-xl border border-outline-variant h-full">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-md">
                    <button className="flex flex-col items-center gap-xs p-md rounded-lg border border-outline-variant hover:border-primary hover:bg-surface-container transition-all group">
                      <span className="material-symbols-outlined text-outline group-hover:text-primary">inventory</span>
                      <span className="text-label-md font-label-md text-on-surface-variant group-hover:text-primary">KMAG_INV</span>
                    </button>
                    <button className="flex flex-col items-center gap-xs p-md rounded-lg border border-outline-variant hover:border-primary hover:bg-surface-container transition-all group">
                      <span className="material-symbols-outlined text-outline group-hover:text-primary">account_balance</span>
                      <span className="text-label-md font-label-md text-on-surface-variant group-hover:text-primary">KFIN_TAX</span>
                    </button>
                    <button className="flex flex-col items-center gap-xs p-md rounded-lg border border-outline-variant hover:border-primary hover:bg-surface-container transition-all group">
                      <span className="material-symbols-outlined text-outline group-hover:text-primary">route</span>
              ...
              <div className="col-span-12 lg:col-span-4">
                <div className="bg-white p-lg rounded-xl border border-outline-variant flex flex-col h-[400px]">
                  ...
                  <div className="flex-1 overflow-y-auto space-y-sm custom-scrollbar pr-xs">
                    {/* Alert 1 */}
                      ...
                      <tbody className="text-body-sm font-body-sm text-on-surface">
                        <tr>
                          ...
                          <td className="px-lg py-md flex items-center gap-xs">
                            <div className="w-6 h-6 rounded-full bg-outline-variant overflow-hidden">
                              <img 
                                alt="Operator" 
                                className="w-full h-full object-cover" 
                                data-alt="A detailed, realistic portrait of a warehouse operator in a navy blue uniform, set against a blurred industrial background of shipping containers. The lighting is bright and clear, emphasizing professionalism and operational readiness. The aesthetic is clean and corporate, matching the high-precision ERP interface style." 
                                src="https://lh3.googleusercontent.com/aida-public/AB6AXuBLy38_eejwPr8MJHy0ltkC9gM0IhfzDluBsW19c59fB5KHkH9QXr0D620A3BoyqpQh7tr0FU9oPQJPN7SU-cUAZ5VGnKfew91Joevp5FKZNNRkxtQ9lkkck7WJoI70NtqXivS2Sh1cJwJPSzwW7ykhSrULhHk1o4hOM_q0CGNGd9LEIdubTFLn9hJ-pRJq8uHBi5R1FO2TVTkTe2XD7SHH2eMrsidalitObeo0mMvScuLTbMesUHOYY4Vrmk6IP4r3o47b_fGIeTg"
                              />
                            </div>
                            J. Chen
                          </td>
                          ...
                          <td className="px-lg py-md flex items-center gap-xs">
                            <div className="w-6 h-6 rounded-full bg-outline-variant overflow-hidden">
                              <img 
                                alt="Operator" 
                                className="w-full h-full object-cover" 
                                data-alt="A portrait of a financial analyst working in a modern, glass-walled office environment. The scene is illuminated by soft, natural daylight, creating a high-key, professional corporate mood. The visual style is minimalist and clean, aligning with a premium enterprise resource planning system aesthetic." 
                                src="https://lh3.googleusercontent.com/aida-public/AB6AXuAjtO3F6zz5RxJhlvw7cVK_sm404zUMOJh_qR7AJacaoXBdGHxY2UYi36rWINW1Zu8TH5GwuK3dWVMCKs954MPUr3JQv6ebP8twJUlBV0WA6-E-Bm1zOmvlWMrwxFr73KdOioe4Jnm32mMrm8RcjlcsydDjGuuvroSBIR5QwbZzcP6nuKnMQdGUX78mrS2-HBGWf5T6G1mAaExa8FZIyArMs8BMMLEoUNYtN7MsM3sMRpT6G8-HDzOVzc6Wzc_YYDgN-wPMbfKvSlI"
                              />
                            </div>
                            S. Miller
                          </td>
                          ...
                          <td className="px-lg py-md flex items-center gap-xs">
                            <div className="w-6 h-6 rounded-full bg-outline-variant overflow-hidden">
                              <img 
                                alt="Operator" 
                                className="w-full h-full object-cover" 
                                data-alt="A high-quality photo of a logistics coordinator using a rugged tablet in a well-lit distribution center. The background features organized warehouse racking under bright industrial LED lighting. The style is professional and grounded in realistic industrial precision, utilizing a cool blue and white color palette." 
                                src="https://lh3.googleusercontent.com/aida-public/AB6AXuCZbM5A_m0TvSvPobX_sZPze8fuVs97YPVWZW5GyVPmwu-tZK5z_eUkcAc-AmWqTO9PO2ypk00EBuxrbFhear6D_H3be_KAG91qcHNAs7vMbOxkhRKJjqEd-WQezJzMocABhIdnEuiSMwr18fPGUv2Xk7Hhu3DAPd7ZAeo1lTCXTCQ6QOIcqi1pPXo5vEmTlltMV0q1yoo7tzTkvUfW-YSOLWXxZttnUz65Z7G6z9KhpQxLLdnKGpQGHuN01MdMCiJQgAGzsVmnybg"
                              />
                            </div>
                            A. Petrov
                          </td>
