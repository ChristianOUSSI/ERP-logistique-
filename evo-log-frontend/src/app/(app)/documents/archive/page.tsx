// src/app/(app)/documents/archive/page.tsx - Documents Digital Archive - FidÃ¨le 100% au HTML original
'use client'
            ...
            <div className="max-w-max-width mx-auto space-y-md">
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-sm mb-lg">
                <div>
                  ...
                  <p className="font-body-md text-body-md text-on-surface-variant mt-xxs">Consultez, recherchez et tÃ©lÃ©chargez les documents gÃ©nÃ©rÃ©s par le systÃ¨me.</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-sm">
                  <div className="col-span-1 md:col-span-2">
                    ...
                    <div className="relative">
                      ...
                      <input className="w-full pl-xl pr-sm py-xs border border-outline-variant rounded focus:ring-2 focus:ring-primary focus:border-primary font-body-sm text-body-sm" placeholder="NÂ° Document, RÃ©fÃ©rence, Client..." type="text"/>
                    </div>
                  </div>
                  <div>
                    ...
                    <select className="w-full px-sm py-xs border border-outline-variant rounded focus:ring-2 focus:ring-primary focus:border-primary font-body-sm text-body-sm bg-surface-container-lowest">
                      ...
                      <option>OpÃ©rations (OT Reports)</option>
                    </select>
                  </div>
                  <div>
                    <label className="block font-label-md text-label-md text-on-surface-variant mb-xxs">PÃ©riode</label>
                    <div className="relative">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-md mb-lg">
                ...
                <div className="bg-surface-container-lowest border border-outline-variant rounded-lg p-md shadow-sm flex flex-col hover:border-primary transition-colors cursor-pointer group">
                  ...
                  <h3 className="font-title-md text-title-md text-on-surface mb-xxs">Factures & ReÃ§us</h3>
              ...
              <div className="bg-surface-container-lowest border border-outline-variant rounded-lg shadow-sm overflow-hidden flex flex-col">
                <div className="p-sm border-b border-outline-variant bg-surface-container flex justify-between items-center">
                  <h3 className="font-title-md text-title-md text-on-surface">Documents RÃ©cents</h3>
                  ...
                  <table className="w-full text-left border-collapse">
                    <thead>
                      <tr className="bg-surface-container-low border-b border-outline-variant">
                        ...
                        <th className="p-sm font-label-md text-label-md text-on-surface-variant font-semibold">RÃ©fÃ©rence</th>
                        <th className="p-sm font-label-md text-label-md text-on-surface-variant font-semibold">Date de GÃ©nÃ©ration</th>
                    ...
                    <tbody className="font-data-tabular text-data-tabular">
                      ...
                      <tr className="border-b border-outline-variant hover:bg-surface-container-low transition-colors group">
                        ...
                        <td className="p-sm text-on-surface-variant">Manifeste DÃ©chargement - CMA CGM</td>
